...
public class RVResult implements org.apache.thrift.TBase<RVResult, RVResult._Fields>, java.io.Serializable, Cloneable, Comparable<RVResult> {
  ...
  public int compareTo(RVResult other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetVoteGranted()).compareTo(other.isSetVoteGranted());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVoteGranted()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("RVResult(");
    boolean first = true;
