...
public class RaftService {
  ...
  public interface Iface {
    ...
    public APResult appendEntries(long term, int leaderId, long prevLogIndex, long prevLogTerm, java.util.List<String> entries, long leaderCommit) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void appendEntries(long term, int leaderId, long prevLogIndex, long prevLogTerm, java.util.List<String> entries, long leaderCommit, org.apache.thrift.async.AsyncMethodCallback<APResult> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_appendEntries(long term, int leaderId, long prevLogIndex, long prevLogTerm, java.util.List<String> entries, long leaderCommit) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class appendEntries_call extends org.apache.thrift.async.TAsyncMethodCall<APResult> {
      ...
      public appendEntries_call(long term, int leaderId, long prevLogIndex, long prevLogTerm, java.util.List<String> entries, long leaderCommit, org.apache.thrift.async.AsyncMethodCallback<APResult> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.term = term;
  ...
  public static class appendEntries_args implements org.apache.thrift.TBase<appendEntries_args, appendEntries_args._Fields>, java.io.Serializable, Cloneable, Comparable<appendEntries_args>   {
    ...
    public java.util.List<String> entries; // required
    ...
    public appendEntries_args(appendEntries_args other) {
      ...
      if (other.isSetEntries()) {
        java.util.List<String> __this__entries = new java.util.ArrayList<String>(other.entries);
    ...
    public void addToEntries(String elem) {
      if (this.entries == null) {
        this.entries = new java.util.ArrayList<String>();
      }
    ...
    public appendEntries_args setEntries(java.util.List<String> entries) {
      this.entries = entries;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case ENTRIES:
        if (value == null) {
          ...
          setEntries((java.util.List<String>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.entries = new java.util.ArrayList<String>(_list0.size);
                  String _elem1;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, appendEntries_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.entries != null) {
          oprot.writeFieldBegin(ENTRIES_FIELD_DESC);
          {
            ...
            for (String _iter3 : struct.entries)
            {
        ...
        if (struct.isSetEntries()) {
          {
            ...
            for (String _iter4 : struct.entries)
            {
        ...
        if (incoming.get(4)) {
          {
            ...
            struct.entries = new java.util.ArrayList<String>(_list5.size);
            String _elem6;
